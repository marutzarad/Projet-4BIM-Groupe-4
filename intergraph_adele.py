...
import random
import pandas as pd
from portrait_robot_adele import *
from torchvision import transforms
from PIL import Image
import torch
from torchvision.utils import make_grid
from torchvision.transforms.functional import to_pil_image
from portrait_robot_adele import attribute_directions, compute_attribute_directions_from_csv
...
def open_fourth_window(parent_latents):
    ...
    tk.Button(frame, text="Encore une génération !", bg="#ad7e66", command=next_generation, padx=10, pady=5).pack(pady=10)
    tk.Button(frame, text="Retour à la génération précédente", bg="#cf7928", command=go_back, padx=10, pady=5).pack(pady=5)
