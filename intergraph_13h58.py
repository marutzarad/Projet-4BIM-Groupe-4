...
import random
import pandas as pd
from portrait_robot_13h58 import *
from torchvision import transforms
from PIL import Image
import torch
from torchvision.utils import make_grid
from torchvision.transforms.functional import to_pil_image
from portrait_robot_13h58 import attribute_directions, compute_attribute_directions_from_csv
...
def open_fourth_window(parent_latents):
    ...
    button_back = tk.Button(fourth_window, text="Go back to the previous generation", bg="#cf7928", command=go_back, padx=10, pady=5, width=30)
...
def open_final_result(image_tensor):
    ...
    final_description = ("And here is the generated image by VisaGen! \n"
                         "We hope that the character created corresponds to \n"
                          "your wishes and that its was an easy and enjoyable experience!\n"
